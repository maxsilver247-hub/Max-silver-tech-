...
export function LogoMark({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      <path
        d="M13.2 2 5 13.6h5.6L10.4 22l8.6-11.8h-5.7L13.2 2Z"
        fill="currentColor"
      />
    </svg>
  );
...
export function CheckIcon({ className }: IconProps) {
  return (
    <svg className={className} {...base} strokeWidth={2.4} aria-hidden="true">
...
export function ArrowRightIcon({ className }: IconProps) {
  return (
    <svg className={className} {...base} strokeWidth={2.2} aria-hidden="true">
      <path d="M5 12h14" />
...
export function CircuitBoardIcon({ className }: IconProps) {
  return (
    <svg className={className} {...base} aria-hidden="true">
